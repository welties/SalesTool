...
@Test
   public void WP_01_Login()
  {
   ...
   public void WP_02_Add_Post()
   {
	   ...
	   String postNo =  urlname.substring(n+1,m);
	   System.out.println("Our post number is " +postNo); 
	   String postDetail = "post-" + postNo;
	   System.out.println("Our post detail is: " +postDetail); 
	   ...
	   // Check that new post is in list of "All Posts"
	   boolean found;
	   found = Utility.isElementPresent(driver, By.id(postDetail),postDetail);
